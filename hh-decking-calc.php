 ...
 * Description:       Stappenplan calculator voor Haarlemse Houthandel.
 * Version:           1.0.1
 * Author:            Jij
...
define( 'HH_DC_VERSION', '0.2.5' ); // Versie opgehoogd
	...
	wp_localize_script(
		...
		array(
			...
			'i18n'   => array(
				...
				'fillReq'   => __( 'Vul alle verplichte velden in om verder te gaan.', 'hh-decking-calc' ),
			),
			'config' => array(
