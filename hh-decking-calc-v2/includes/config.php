...
const CONFIG = [
	...
	'mappings' => [
		...
		// Vlonderplanken
		// LET OP: alle vlonderplanken zijn 18mm dik; ze verschillen in BREEDTE (width_mm)
		// en in plank-LENGTE (product_length_mm). De wizard laat de klant de breedte
		// kiezen via de "Maat plank"-stap (zie find_mapping() in class-calculator.php),
		// en de rekenregel gebruikt vervolgens de bijbehorende product_length_mm.
		'hhline_bamboe_plank_espresso_18x100x1860' => [
			'type'               => 'bamboe',
			'subtype'            => 'plank',
			'color'              => 'espresso',
			'label'              => 'HHLine Bamboe Vlonderplank Espresso 18x100x1860',
			'width_mm'           => 100,
			'thick_mm'           => 18,
